-- Permite concluir pedidos de entrega quando o cálculo de frete estiver desativado no admin.
-- Nesse caso distance_km vem nulo, a taxa fica 0 no banco e a operação segue como "a confirmar" no app/admin.
