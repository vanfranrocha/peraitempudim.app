-- Finaliza a integração Telegram usando secret do Supabase Vault e triggers idempotentes.
-- Não armazena TELEGRAM_WEBHOOK_SECRET em migration, código ou logs.
-- Secret esperado no Vault: telegram_webhook_secret
